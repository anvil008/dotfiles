...
defaults write NSGlobalDomain AppleLocale -string "en_GB@currency=GDP"
...
# Finder: allow quitting via ⌘ + Q; doing so will also hide desktop icons (disabled currently)
...
# Disable the warning before emptying the Trash (currently enabled)
